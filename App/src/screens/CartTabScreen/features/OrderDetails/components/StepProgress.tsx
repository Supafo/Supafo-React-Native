    ...
    <View style={styles.main}>
      ...
      <View style={styles.wrapper}>
        <View style={[styles.container]}>
          <View style={[styles.iconContainer, {opacity: detail == 'PreparingOrder' ? 1 : 0.6 }]}>
      ...
      <View style={styles.wrapper}>
        <View style={styles.container}>
          <View style={styles.banner} />
          <View style={[styles.iconContainer, {opacity: detail == 'OrderCompleted' ? 1 : 0.6 }]}>
            <Image
      ...
      <View style={styles.wrapper}>
        <View style={[styles.container]}>
          <View style={{flexDirection:'column'}} >
            <View style={[styles.iconContainer, {opacity: detail == 'OrderDelivered' ? 1 : 0.6}]}>
